...
import { blogs, info } from "../constants";
...
const BlogDetails = () => {
  ...
  const relatedBlogs = blogs.filter((b) => blog.relatedBlogs.includes(b.slug));

  return (
    <>
      <div className="max-w-6xl px-4 pt-6 lg:pt-10 pb-12 sm:px-6 lg:px-8 mx-auto">
        <a
          class="inline-flex items-center gap-x-1.5 text-sm text-gray-600 decoration-2 hover:underline focus:outline-none focus:underline dark:text-blue-500  mb-8"
          href="/blogs"
        >
          <svg
                      ...
                      <div className="hs-tooltip-toggle sm:mb-1 block text-start cursor-pointer">
                        ...
                        >
                          ...
                          <div className="flex justify-between items-center px-4 py-3 sm:px-5">
                            ...
                            <div>
                              <a
                                href={`mailto:${info.personalInfo.email}`}
